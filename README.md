...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-psychotree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14626&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-psychotree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-psychotree` can be installed with:

```
conda install r-psychotree
```

It is possible to list all of the versions of `r-psychotree` available on your platform with:
